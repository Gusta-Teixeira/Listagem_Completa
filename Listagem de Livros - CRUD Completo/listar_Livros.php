...
include_once 'DAO/autor_dao.php';
...
<body>
	...
	<div>
		...
		<div style="text-align: left; padding: 30px;">
			<button type="button" class="btn btn-primary" onclick="window.location='logout.php'">Sair</button>
		</div>
		...
		<table class="table table-striped">
			...
			for($i = 0; $i < count ( $listaLivros ); $i ++) {
				...
				<tr>
					...
					<td><a
						href="dados_editora.php?id=<?=$editora->getCodigo()?>"><?=$editora->getNome()?></a></td>
					<td><a href="dados_livro.php?id=<?=$livro->getCodigo()?>"><span
